                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="user_name" placeholder="Name" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <textarea class="form-control" name="Massage" placeholder="type  your massage" required></textarea>
                                    </div>
                                </div>
